...
SCRIPT_DIR="/isilon/sequencing/VITO/NEW_GIT_REPO/Mendel_Release_SetUp_Revamp/DEVEL/SCRIPTS"
...
mkdir -p $CORE_PATH/$PROJECT/TEMP/GVCF_LIST_SPLIT/
mkdir -p $CORE_PATH/$PROJECT/MULTI_SAMPLE/VARIANT_SUMMARY_STAT_VCF/


CREATE_PROJECT_INFO_ARRAY (){
PROJECT_INFO_ARRAY=(`sed 's/\r//g' $SAMPLE_SHEET | sed 's/,/\t/g' | awk 'NR>1 {print $12,$18,$16}' | sort | uniq`)

REF_GENOME=${PROJECT_INFO_ARRAY[0]}
PROJECT_DBSNP=${PROJECT_INFO_ARRAY[1]}
PROJECT_BAIT_BED=${PROJECT_INFO_ARRAY[2]}
}

######### FORMAT OF SPECIFIC BEDFILE HARDCODED ABOVE FOR MENDEL ############
...
FORMAT_AND_SPLIT_GVCF_LIST() {
GVCF_FILE_PREFIX=(`echo GVCF_LIST_SPLIT_`)

split -l 200 -a 4 -d $GVCF_LIST $CORE_PATH/$PROJECT/TEMP/GVCF_LIST_SPLIT/$GVCF_FILE_PREFIX

ls $CORE_PATH/$PROJECT/TEMP/GVCF_LIST_SPLIT/GVCF_LIST_SPLIT_* | awk '{print "mv",$0,$0".list"}' | bash
}
...
echo \
 qsub \
 -N 'A01_COMBINE_GVCF_'$PROJECT'_'$BED_FILE_NAME'_'$MINI_GVCF_FILE_NAME \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_A01_COMBINE_GVCF_'$BED_FILE_NAME'_'$MINI_GVCF_FILE_NAME.log \
 $SCRIPT_DIR/A01_COMBINE_GVCF.sh \
 $JAVA_1_7 $GATK_DIR $REF_GENOME \
 $KEY $CORE_PATH $PROJECT $MINI_GVCF_FILE_NAME \
 $PREFIX $BED_FILE_NAME	
}

GENERATE_GENOTYPE_GVCF_HOLDID(){
	GENOTYPE_GVCF_HOLDID=$GENOTYPE_GVCF_HOLDID'A01_COMBINE_GVCF_'$PROJECT'_'$BED_FILE_NAME'_'$MINI_GVCF_FILE_NAME','
}

# This will be similar to the combine variants command with this damn list
GENOTYPE_GVCF(){
	MINI_GVCF_LIST_FILE_NAMES=`ls $CORE_PATH/$PROJECT/TEMP/GVCF_LIST_SPLIT/GVCF_LIST_SPLIT_* | awk '{print "basename",$0,".list"}' | bash`

echo \
 qsub \
 -N B02_GENOTYPE_GVCF_$PROJECT'_'$BED_FILE_NAME \
 -hold_jid $GENOTYPE_GVCF_HOLDID \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_B02_GENOTYPE_GVCF_'$BED_FILE_NAME.log \
 $SCRIPT_DIR/B02_GENOTYPE_GVCF.sh \
 $JAVA_1_7 $GATK_DIR $REF_GENOME \
 $KEY $CORE_PATH $PROJECT \
 $PREFIX $BED_FILE_NAME $MINI_GVCF_LIST_FILE_NAMES
}
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_C03_VARIANT_ANNOTATOR_'$BED_FILE_NAME.log \
...
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT_D04_COMBINE_VARIANTS.log \
#  $SCRIPT_DIR/D04_COMBINE_VARIANTS.sh \
#  $JAVA_1_7 $GATK_3_1_1_DIR $REF_GENOME $KEY \
#  $CORE_PATH $PROJECT $PREFIX $VCF_FILE_LIST
# }
# 
...
#  -N D04_COMBINE_VARIANTS_$PROJECT \
#  -hold_jid $COMBINE_VARIANTS_HOLD_ID \
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.D04_COMBINE_VARIANTS.log \
#  $SCRIPT_DIR/D04_COMBINE_VARIANTS.sh \
#  $JAVA_1_7 $GATK_3_1_1_DIR $REF_GENOME $KEY \
...
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.H08A_SELECT_RARE_BIALLELIC.log \
...
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.H08A-1_ANNOTATE_SELECT_RARE_BIALLELIC.log \
...
#  -hold_jid G07_APPLY_RECALIBRATION_INDEL_$PROJECT \
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.H08B_SELECT_COMMON_BIALLELIC.log \
...
#  -hold_jid G07_APPLY_RECALIBRATION_INDEL_$PROJECT \
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.H08C_SELECT_MULTIALLELIC.log \
...
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.I09_COMBINE_VARIANTS_VCF.log \
...
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.I09-1_BGZIP_AND_TABIX_COMBINED_VCF.log \
...
#  -hold_jid I09_COMBINE_VARIANTS_VCF_$PROJECT \
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.J10A_SELECT_VARIANTS_FOR_SAMPLE.log \
...
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.J10A-1_BGZIP_AND_TABIX_SAMPLE_VCF.log \
...
#  -hold_jid J10A_SELECT_VARIANTS_FOR_SAMPLE_$JOB_ID_SM_TAG \
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.K11A_SELECT_VARIANTS_ON_TARGET_BY_SAMPLE_.log \
...
#  -hold_jid J10A_SELECT_VARIANTS_FOR_SAMPLE_$JOB_ID_SM_TAG \
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.K11B_SELECT_SNVS_ON_BAIT_BY_SAMPLE_.log \
...
#  -hold_jid J10A_SELECT_VARIANTS_FOR_SAMPLE_$JOB_ID_SM_TAG \
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.K11C_SELECT_SNVS_ON_TARGET_BY_SAMPLE_.log \
...
#  -hold_jid J10A_SELECT_VARIANTS_FOR_SAMPLE_$JOB_ID_SM_TAG \
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.K11D_SELECT_INDELS_ON_BAIT_BY_SAMPLE_.log \
...
#  -hold_jid J10A_SELECT_VARIANTS_FOR_SAMPLE_$JOB_ID_SM_TAG \
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.K11E_SELECT_INDELS_ON_TARGET_BY_SAMPLE_.log \
...
#  -hold_jid J10A_SELECT_VARIANTS_FOR_SAMPLE_$JOB_ID_SM_TAG \
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.K11F_SELECT_SNVS_TITV_ALL_.log \
...
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.K11F-1_TITV_ALL.log \
...
#  -hold_jid J10A_SELECT_VARIANTS_FOR_SAMPLE_$JOB_ID_SM_TAG \
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.K11G_SELECT_SNVS_TITV_KNOWN.log \
...
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.K11G-1_TITV_KNOWN.log \
...
#  -hold_jid J10A_SELECT_VARIANTS_FOR_SAMPLE_$JOB_ID_SM_TAG \
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.K11H_SELECT_SNVS_TITV_NOVEL.log \
...
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.K11H-1_TITV_NOVEL.log \
...
# echo \
#  qsub \
#  -N L12_CONCORDANCE_ON_TARGET_PER_SAMPLE_$JOB_ID_SM_TAG \
#  -hold_jid K11F-1_TITV_ALL_$JOB_ID_SM_TAG','K11G-1_TITV_KNOWN_$JOB_ID_SM_TAG','K11H-1_TITV_NOVEL_$JOB_ID_SM_TAG \
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.L12_CONCORDANCE_ON_TARGET_PER_SAMPLE.log \
...
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.K11B-1_SETUP_AND_RUN_ANNOVER.log \
#  -q rnd.q,test.q -pe slots 5 $SCRIPT_DIR/K11B-1_SETUP_AND_RUN_ANNOVER.sh \
...
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.K11I_HC_BED_GENERATION.log \
...
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.K11I-1_HC_BAM_GENERATION.log \
...
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.K11I-1-1_BGZIP_AND_TABIX_HC_VCF.log \
...
#  	 -hold_jid I09_COMBINE_VARIANTS_VCF_$PROJECT \
# 	 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.J10B_GENERATE_MENDEL_HAPMAP_SAMPLE_LISTS.log \
...
# 	 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.J10B_SELECT_SNPS_FOR_ALL_SAMPLES.log \
...
# 	 -hold_jid J10_GENERATE_MENDEL_HAPMAP_SAMPLE_LISTS_$PROJECT \
# 	 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.J10C_SELECT_PASS_MENDEL_ONLY_SNP.log \
...
# 	 -hold_jid J10_GENERATE_MENDEL_HAPMAP_SAMPLE_LISTS_$PROJECT \
# 	 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.J10D_SELECT_PASS_HAPMAP_ONLY_SNP.log \
...
# 	 -hold_jid J10_GENERATE_MENDEL_HAPMAP_SAMPLE_LISTS_$PROJECT \
# 	 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.J10E_SELECT_INDELS_FOR_ALL_SAMPLES.log \
...
# 	 -hold_jid J10_GENERATE_MENDEL_HAPMAP_SAMPLE_LISTS_$PROJECT \
# 	 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.J10F_SELECT_PASS_MENDEL_ONLY_INDEL.log \
...
# 	 -hold_jid J10_GENERATE_MENDEL_HAPMAP_SAMPLE_LISTS_$PROJECT \
# 	 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.J10G_SELECT_PASS_HAPMAP_ONLY_INDEL.log \
...
if [ -d $CORE_PATH/$PROJECT/TEMP/GVCF_LIST_SPLIT ]
then
	rm -rf $CORE_PATH/$PROJECT/TEMP/GVCF_LIST_SPLIT
fi
...
for MINI_GVCF in $(ls $CORE_PATH/$PROJECT/TEMP/GVCF_LIST_SPLIT/GVCF_LIST_SPLIT_*)
do
	MINI_GVCF_FILE_NAME=$(basename $MINI_GVCF .list)
COMBINE_GVCF_FOR_MINI_GVCF
GENERATE_GENOTYPE_GVCF_HOLDID
done
GENOTYPE_GVCF
