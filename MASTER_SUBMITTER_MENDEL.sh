...
echo \
 qsub \
 -N J10_SELECT_VARIANTS_FOR_SAMPLE_$JOB_ID_SM_TAG \
 -hold_jid I09_COMBINE_VARIANTS_VCF_$PROJECT \
...
echo \
 qsub \
 -N J10-1_BGZIP_AND_TABIX_SAMPLE_VCF_$JOB_ID_SM_TAG \
 -hold_jid J10_SELECT_VARIANTS_FOR_SAMPLE_$JOB_ID_SM_TAG \
