...
echo \
 ...
 -hold_jid G07_APPLY_RECALIBRATION_INDEL_$PROJECT \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_H08C_SELECT_MULTIALLELIC.log' \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_I09_COMBINE_VARIANTS_VCF.log' \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_I09-1_BGZIP_AND_TABIX_COMBINED_VCF.log' \
...
echo \
 ...
 -hold_jid I09_COMBINE_VARIANTS_VCF_$PROJECT \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_'$SM_TAG'_J10A_SELECT_VARIANTS_FOR_SAMPLE.log' \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_'$SM_TAG'_J10A-1_BGZIP_AND_TABIX_SAMPLE_VCF.log' \
...
echo \
 ...
 -hold_jid J10A_SELECT_VARIANTS_FOR_SAMPLE_$JOB_ID_SM_TAG \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_'$SM_TAG'_K11A_SELECT_VARIANTS_ON_TARGET_BY_SAMPLE.log' \
...
echo \
 ...
 -hold_jid J10A_SELECT_VARIANTS_FOR_SAMPLE_$JOB_ID_SM_TAG \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_'$SM_TAG'_K11B_SELECT_SNVS_ON_BAIT_BY_SAMPLE.log' \
...
echo \
 ...
 -hold_jid J10A_SELECT_VARIANTS_FOR_SAMPLE_$JOB_ID_SM_TAG \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_'$SM_TAG'_K11C_SELECT_SNVS_ON_TARGET_BY_SAMPLE.log' \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_'$SM_TAG'_K11C-1_CONCORDANCE_ON_TARGET_PER_SAMPLE.log' \
...
echo \
 ...
 -hold_jid J10A_SELECT_VARIANTS_FOR_SAMPLE_$JOB_ID_SM_TAG \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_'$SM_TAG'_K11D_SELECT_INDELS_ON_BAIT_BY_SAMPLE.log' \
...
echo \
 ...
 -hold_jid J10A_SELECT_VARIANTS_FOR_SAMPLE_$JOB_ID_SM_TAG \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_'$SM_TAG'_K11E_SELECT_INDELS_ON_TARGET_BY_SAMPLE.log' \
...
echo \
 ...
 -hold_jid J10A_SELECT_VARIANTS_FOR_SAMPLE_$JOB_ID_SM_TAG \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_'$SM_TAG'_K11F_SELECT_SNVS_TITV_ALL.log' \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_'$SM_TAG'_K11F-1_TITV_ALL.log' \
...
echo \
 ...
 -hold_jid J10A_SELECT_VARIANTS_FOR_SAMPLE_$JOB_ID_SM_TAG \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_'$SM_TAG'_K11G_SELECT_SNVS_TITV_KNOWN.log' \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_'$SM_TAG'_K11G-1_TITV_KNOWN.log' \
...
echo \
 ...
 -hold_jid J10A_SELECT_VARIANTS_FOR_SAMPLE_$JOB_ID_SM_TAG \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_'$SM_TAG'_K11H_SELECT_SNVS_TITV_NOVEL.log' \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_'$SM_TAG'_K11H-1_TITV_NOVEL.log' \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_'$SM_TAG'_K11B-1_SETUP_AND_RUN_ANNOVER.log' \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_'$SM_TAG'_K11I_HC_BED_GENERATION.log' \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_'$SM_TAG'_K11I-1_HC_BAM_GENERATION.log' \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_'$SM_TAG'_K11I-1-1_BGZIP_AND_TABIX_HC_VCF.log' \
...
GENERATE_MENDEL_HAPMAP_SAMPLE_LISTS () 
{
	...
	echo \
	 ...
	 -N J10_GENERATE_MENDEL_HAPMAP_SAMPLE_LISTS_$PROJECT \
 	 -hold_jid I09_COMBINE_VARIANTS_VCF_$PROJECT \
	 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_J10B_GENERATE_MENDEL_HAPMAP_SAMPLE_LISTS.log' \
...
SELECT_SNVS_ALL () 
{
	echo \
	 ...
	 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_J10B_SELECT_SNPS_FOR_ALL_SAMPLES.log' \
...
SELECT_PASS_MENDEL_ONLY_SNP () 
{
	echo \
	 ...
	 -hold_jid J10_GENERATE_MENDEL_HAPMAP_SAMPLE_LISTS_$PROJECT \
	 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_J10C_SELECT_PASS_MENDEL_ONLY_SNP.log' \
...
SELECT_PASS_HAPMAP_ONLY_SNP ()
{
	echo \
	 ...
	 -hold_jid J10_GENERATE_MENDEL_HAPMAP_SAMPLE_LISTS_$PROJECT \
	 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_J10D_SELECT_PASS_HAPMAP_ONLY_SNP.log' \
...
SELECT_INDELS_ALL ()
{
	echo \
	 ...
	 -hold_jid J10_GENERATE_MENDEL_HAPMAP_SAMPLE_LISTS_$PROJECT \
	 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_J10E_SELECT_INDELS_FOR_ALL_SAMPLES.log' \
...
SELECT_PASS_MENDEL_ONLY_INDELS ()
{
	echo \
	 ...
	 -hold_jid J10_GENERATE_MENDEL_HAPMAP_SAMPLE_LISTS_$PROJECT \
	 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_J10F_SELECT_PASS_MENDEL_ONLY_INDEL.log' \
...
SELECT_PASS_HAPMAP_ONLY_INDELS ()
{
	echo \
	 ...
	 -hold_jid J10_GENERATE_MENDEL_HAPMAP_SAMPLE_LISTS_$PROJECT \
	 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_J10G_SELECT_PASS_HAPMAP_ONLY_INDEL.log' \
