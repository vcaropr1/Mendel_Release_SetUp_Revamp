...
echo \
 ...
 -hold_jid I09_COMBINE_VARIANTS_VCF_$PROJECT \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.J10_SELECT_VARIANTS_FOR_SAMPLE.log \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.J10-1_BGZIP_AND_TABIX_SAMPLE_VCF.log \
