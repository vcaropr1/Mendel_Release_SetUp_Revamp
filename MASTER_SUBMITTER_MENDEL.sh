...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_A01_COMBINE_GVCF_'$BED_FILE_NAME.log \
...
#  -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_A01_COMBINE_GVCF_'$BED_FILE_NAME'_'$MINI_GVCF_LIST.log \
#  $SCRIPT_DIR/A01_COMBINE_GVCF.sh \
#  $JAVA_1_7 $GATK_DIR $REF_GENOME \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_D04_COMBINE_VARIANTS.log' \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.E05A'_VARIANT_RECALIBRATOR_SNV.log' \
...
echo \
 ...
 -hold_jid D04_COMBINE_VARIANTS_$PROJECT \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_E05B_VARIANT_RECALIBRATOR_INDEL.log' \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_F06_APPLY_RECALIBRATION_SNV.log' \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_G07_APPLY_RECALIBRATION_INDEL.log' \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_H08A_SELECT_RARE_BIALLELIC.log' \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_H08A-1_ANNOTATE_SELECT_RARE_BIALLELIC.log' \
...
echo \
 ...
 -hold_jid G07_APPLY_RECALIBRATION_INDEL_$PROJECT \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT'_H08B_SELECT_COMMON_BIALLELIC.log' \
